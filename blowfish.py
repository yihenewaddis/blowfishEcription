...
def driver():
    while True:
        ...
        if choice.lower() == 'e':
            ...
            # Convert string to integer using hexadecimal representation
            data_int = string_to_int(data)
            encrypted_data = encryption(data_int)
            print("Encrypted data : ", encrypted_data)
        elif choice.lower() == 'd':
            data = int(input("Enter data to decrypt: "))
            decrypted_data = decryption(data)
            # Convert integer back to string using hexadecimal representation
            decrypted_string = int_to_string(decrypted_data)
